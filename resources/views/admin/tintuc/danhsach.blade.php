					...
					<table class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"><a href="admin/tintuc/edit/{{$tintuc->id}}"><i class="icon icon-pencil"></i> sửa</a></td>
									<td class="center"><a href="admin/tintuc/delete/{{$tintuc->id}}"><i class="icon icon-bin"></i> Xóa</a></td>
								</tr>
								@endforeach
							</tbody>
						</table>
