									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td class="center"><a href="admin/loaisp/edit/{{$lsp->id}}"><i class="icon icon-pencil"></i> Sửa</a></td>
												<td class="center"><a href="admin/loaisp/delete/{{$lsp->id}}"><i class="icon icon-bin"></i> Xóa</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
