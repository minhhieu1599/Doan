					...
					<table class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$ncc->phone}}</td>
									<td>{{$ncc->email}}</td>
									<td class="center"><a href="admin/nhacungcap/edit/{{$ncc->id}}"><i class="icon icon-pencil"></i> Sửa</a></td>
									<td class="center"><a href="admin/nhacungcap/delete/{{$ncc->id}}"><i class="icon icon-bin"></i> Xóa</a></td>
								</tr>
								@endforeach
							</tbody>
						</table>
