...
<!-- BREADCRUMB -->
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="http://localhost:81/noithat/public/index">Home</a></li>
				<li class="active"><a href="http://localhost:81/noithat/public/dang-nhap">ĐĂNG NHẬP TÀI KHOẢN</a></li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
<div class="login-container">
    ...
    margin: auto; height: 500px; margin-top: 20px;">
					...
					<div class="footer text-muted text-center">
						&copy; . <a href="#"></a> <a href="http://themeforest.net/user/Kopyov" target="_blank"></a>
					</div>
					<!-- /footer -->
