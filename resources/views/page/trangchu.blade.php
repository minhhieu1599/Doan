				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2">
						...
						<div class="banner-caption">
							<h2 class="white-color">MỚI<br>Bộ sưu tầm</h2>
						...
						<div id="product-slick-1" class="product-slick">
							...
							<div class="product product-single">
								<div class="product-thumb" style="height: 250px;">
									...
									<button class="main-btn quick-view"><a href="{{route('chitietsanpham',$new->id)}}"><i class="fa fa-search-plus"></i> xem chi tiết</a></button>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="banner banner-1">
						...
						<div class="banner-caption text-center">
							<h1 class="primary-color">HOT HOT<br><span class="white-color font-weak">Lên tới 50%</span></h1>
							<a href="http://localhost:81/noithat/public/san-pham-giam-gia"><button class="primary-btn">mua ngay</button></a>
						</div>
					</div>
				</div>
				<!-- /banner -->
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="http://localhost:81/noithat/public/san-pham-moi">
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="http://localhost:81/noithat/public/san-pham-moi">
						<img src="source/image/slide/Untitled.png" alt="">
						<div class="banner-caption text-center">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2">
						...
						<div class="banner-caption">
							<h2 class="white-color">sản phẩm khuyễn mãi</h2>
							<button class="primary-btn">mua ngay</button>
						</div>
					</div>
				</div>
						...
						<div id="product-slick-2" class="product-slick">
							...
							<div class="product product-single">
								<div class="product-thumb">
									...
									<button class="main-btn quick-view"><a href="{{route('chitietsanpham',$spkm->id)}}"><i class="fa fa-search-plus"></i> xem chi tiết</a></button>
