	<header>
		...
		<div id="top-header">
			<div class="container">
				<div class="pull-left">
					<span>Chào mừng bạn đến với nội thất của chúng tôi!</span>
				</div>
			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-logo">
						<a class="logo" href="http://localhost:81/noithat/public/index">
							<img src="source/assets/img/log.png" alt="" >
						</a>
					</div>
					<!-- /Logo -->
				...
				<div class="pull-right">
					<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown" style="width: 200px;">
							...
							<ul class="custom-menu">
								<li><a href="http://localhost:81/noithat/public/admin/layout/trangchu"><i class="fa fa-user-o"></i>Admin</a></li>
							...
							<div class="custom-menu">
								<div id="shopping-cart">
									...
									<div class="shopping-cart-btns">
										...
										<a href="http://localhost:81/noithat/public/dat-hang"><button class="primary-btn">Đặt Hàng <i class="fa fa-arrow-circle-right"></i></button></a>
									</div>
										@endif
								</div>
							</div>
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						<li><a href="http://localhost:81/noithat/public/index">Trang Chủ</a></li>
						<li><a href="http://localhost:81/noithat/public/san-pham-moi">HÀNG MỚI VỀ</a></li>
						<li><a href="http://localhost:81/noithat/public/san-pham-giam-gia">HÀNG GIẢM GIÁ</a></li>
						<li><a href="http://localhost:81/noithat/public/lien-he">Liên Hệ</a></li>
						<li><a href="http://localhost:81/noithat/public/gioi-thieu">Giới Thiệu</a></li>
						<li><a href="http://localhost:81/noithat/public/tin-tuc">Tin Tức</a></li>
					</ul>
				</div>
				<!-- menu nav -->
			</div>
